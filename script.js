...
function checkUI(){
    ...
    formBtn.innerHTML = '<i class="fa-solid fa-plus"></i> Add Book';
...
function init(){
bookForm.addEventListener('submit', onAddBookSubmit);
